...
Процедура ИсполняемыеСценарии() Экспорт
    ...
    ЮТТесты
    	...
    	.ДобавитьТест("Тест_ЗаполнитьЗаменяемыеПоля")
    	;
...
#Область Набор_ЗаполнитьЗаменяемыеПоля

Процедура Тест_ЗаполнитьЗаменяемыеПоля() Экспорт
	...
	Обработка = НоваяОбработка();
	Обработка.ЗаполнитьЗаменяемыеПоля(ЗаменяемыеПоля);
	
	ЗаменяемыеПоля = Обработка.ЗаменяемыеПоля;
	ЮТест.ОжидаетЧто(ЗаменяемыеПоля.Количество(), "Верное количество полей").Равно(3);
	
	ЮТест.ОжидаетЧто(ЗаменяемыеПоля[0], "Первая строка")
		.Свойство("ПутьДо").Равно("Поле1")
		.Свойство("ПутьПосле").Равно("Поле2");
	
	ЮТест.ОжидаетЧто(ЗаменяемыеПоля[1], "Вторая строка")
		.Свойство("ПутьДо").Равно("Поле3.Поле4")
		.Свойство("ПутьПосле").Равно("Поле5");
	
	ЮТест.ОжидаетЧто(ЗаменяемыеПоля[2], "Третья строка")
		.Свойство("ПутьДо").Равно("Поле6")
		.Свойство("ПутьПосле").Равно("Поле7.Поле8");
